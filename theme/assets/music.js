...
eval("$(document).ready(function () {\n  /* home-slider*/\n  $('.home-slider').slick({\n    slidesToShow: 1,\n    slidesToScroll: 1\n  });\n  /* menu */\n\n  $(\".child\").hide();\n  $(\".child\").parent(\"li\").hover(function () {\n    $(this).find(\">.child\").slideDown(1000);\n  });\n  $(\".child\").parent(\"li\").mouseleave(function () {\n    $(this).find(\">.child\").slideUp(200);\n  });\n});\n\n//# sourceURL=webpack:///./javascript/wokiee.js?");
